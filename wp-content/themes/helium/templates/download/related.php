<?php
$related_items_count = Youxi()->option->get( 'edd_related_items_count' );
	...
	<div class="content-wrap-inner three-quarters-vertical-padding">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<h4 class="bordered no-margin-top"><?php esc_html_e( 'Related Downloads', 'helium' ); ?></h4>
				</div>
			...
			$use_lightbox = ( 'lightbox' === Youxi()->option->get( 'edd_related_items_behavior' ) );
			...
			?><article <?php post_class( array( 'related-entry', 'col-md-' . $col_width ) ); ?>>
				...
				?><p class="related-entry-meta"><?php echo edd_price( get_the_ID() ); ?></p>
