...
require_once( dirname( __FILE__ ) . '/class-fvd.php' );
require_once( dirname( __FILE__ ) . '/class-websafe.php' );
require_once( dirname( __FILE__ ) . '/class-google-font.php' );
require_once( dirname( __FILE__ ) . '/class-typekit.php' );
