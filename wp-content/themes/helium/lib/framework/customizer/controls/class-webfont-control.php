...
class Youxi_Customize_WebFont_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->providers['websafe'] = new Youxi_Customize_WebFont_Websafe( $this, 'websafe', $args['websafe'] );
		$this->providers['google']  = new Youxi_Customize_WebFont_Google( $this, 'google', $args['google'] );
		$this->providers['typekit'] = new Youxi_Customize_WebFont_Typekit( $this, 'typekit', $args['typekit'] );
	}
